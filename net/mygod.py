...
import user.user_go_https, user.user_http, user.user_https, user.user_py_https, user.user_udp, user.user_dns


protocal_dict = {'udp': user.user_udp,
                 'http': user.user_http,
                 'https': user.user_https,
                 'pyhttps': user.user_py_https,
                 'gohttps': user.user_go_https,
                 'dns': user.user_dns,
                 }
